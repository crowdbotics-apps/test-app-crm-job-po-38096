...
## Project Structure
    ...
    ├── test_app_crm_job_po_38096  # Django project configurations
...
1. Clone this repo and `cd test_app_crm_job_po_38096`
...
2. Clone this repo and `cd test_app_crm_job_po_38096`
